...
public class FormReporteVotante extends JFrame implements ActionListener, MouseListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormReporteVotante frame = new FormReporteVotante();
