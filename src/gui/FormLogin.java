...
public class FormLogin extends JFrame implements MouseListener, FocusListener, ActionListener {
	...
	private Image img_login= new ImageIcon(FormLogin.class.getResource("/resources/login.png")).getImage().getScaledInstance(40, 40, Image.SCALE_SMOOTH);
	private Image img_salir= new ImageIcon(FormLogin.class.getResource("/resources/exit.png")).getImage().getScaledInstance(60, 60, Image.SCALE_SMOOTH);
	private Image img_regresar= new ImageIcon(FormLogin.class.getResource("/resources/regresar.png")).getImage().getScaledInstance(60, 60, Image.SCALE_SMOOTH);
